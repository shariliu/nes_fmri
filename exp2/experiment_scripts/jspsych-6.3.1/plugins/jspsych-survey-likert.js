...
jsPsych.plugins['survey-likert'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += ".jspsych-survey-likert-statement { display:block; font-size: 30px; padding-top: 40px; margin-bottom:10px; }"+
      ".jspsych-survey-likert-opts { list-style:none; width:"+w+"; margin:auto; padding:0 0 35px; display:block; font-size: 24px; line-height:1.4em; }"+
      ".jspsych-survey-likert-opt-label { line-height: 1.4em; color: #000000; }"+
