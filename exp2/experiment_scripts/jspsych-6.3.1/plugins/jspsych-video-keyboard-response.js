...
jsPsych.plugins["video-keyboard-response"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      add_border: {
        type: jsPsych.plugins.parameterType.BOOL,
        pretty_name: 'Add a red border around the video',
        default: false,
        description: 'If true, then red border is added around the video. '+
          'If false, then no borders are added.'
      }
    }
  }
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if(trial.add_border){
      video_html += ' style="border: 10px solid #FF0000" '
    }
    if(trial.width) {
