window.jsPsych = (function() {
  ...
  core.pauseExperiment = function(){
  	paused = true;
    var keyboardListener = document.addEventListener('keydown', function(event) {
 		if (event.key == "r") {
      		console.log("r was pressed");
      		core.resumeExperiment();
      	}
      	if (event.key == "q") {
      ...
      // function to handle responses by the subject -- this is not used anymore 
    var dowhatwithpause = function(info) {
		console.log(info)
      if (info.key == "r") {
      	console.log("r was pressed");
      	core.resumeExperiment();
